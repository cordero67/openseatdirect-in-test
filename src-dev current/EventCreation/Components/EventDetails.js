    ...
    return (
        <Fragment>
            ...
            <div style={{ border: "1px solid grey" }}>
                    ...
                    (<Fragment>
                        ...
                        >
                            ...
                            {eventZipPostalWarning
                                ? (<div>
                                    {displayMessage(5, props.event.locationPostalCode)}
                                </div>)
                                : null
                            }
                        </div>
                        ...
                        <div className={classes.InputBox}>
                            ...
                            {eventAdditionalWarning ?
                                displayMessage(256, props.event.locationNote) : null
                            }
                        </div>
                ...
                {props.event.eventType === "online" || props.event.eventType === "live"
                    ? (<Fragment>
                        <div className={classes.SectionTitleTight}>
                            Online Information
                        </div>
                ...
                <div className={classes.VanityGridBoxGrid}>
                    <div>{" "}</div>
                    {vanityWarning
                        ? displayMessage(75, props.event.vanityLink)
                        : null
                    }
                </div>
