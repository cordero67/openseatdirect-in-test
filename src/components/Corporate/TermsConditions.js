...
const Privacy = () => {
  ...
  return (
    <div className={classes.MainContainer}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to OpenSeatDirect LLC, 15
            Wilkinson Avenue Unit 3 A-1, Jersey City NJ 07305.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to OpenSeatDirect, accessible from{" "}
            <a
              href="https://www.openseatdirect.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.openseatdirect.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@openseatdirect.com</li>
      </ul>
    </div>
  );
};
