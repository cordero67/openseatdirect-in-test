...
const eventTixOrig = { // sample data
  ...
  tickets: [
    {
      ...
      currency: "USD",
      language: "JPN",
      ticketDescription: "レッスンを始める前の１５分間のコンサルテーションです。ゴールの設定やクラスの進め方、又、ご自身のレベルが分からなかったり、ご質問がある場合にもお気軽にご相談ください。",
    ...
    },
    {
      ...
      currency: "JPY",
      language: "JPN",
      ticketDescription: "オンライン30分プライベートコースです。イキイキと楽しみながら、自信を持って技術やテクニックをレベルアップしていただけるプライベートレッスンです。一回づつお気軽にも、お得なパッケージ料金もございます",      
      showTicketDescOnEventPage:{type:"Boolean"},
    ...
    },
    {
      ...
      currency: "USD",
      language: "JPN",
      ticketDescription: "１週間毎日受講いただけるお得なプランです。１週間有効 英語３０分プライベートレッスンオンライン。１日１レッスンまでとします。",
      showTicketDescOnEventPage: {type:"Boolean"},
    ...
    },
    {
      ...
      currency: "JPY",
      language: "JPN",
      ticketDescription: "３０日間有効の合計１０回のプランです。Valid for one month Select • 英語３０分プライベートレッ",
      showTicketDescOnEventPage:{type:"Boolean"},
...
const dataFields = {
  ...
  tickets: {
    ...
    remainingQuantity: {type: "Number", required: true, validate: "isInteger"}, // fetch
...
let eventTix = {};
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("eventTix")) {
      ...
      tempDescription.eventType = eventTix.eventType; // fetch
      ...
      tempDescription.refundPolicy = eventTix.refundPolicy; // fetch
      tempDescription.eventNum = eventTix.eventNum; // fetch
      ...
      console.log("tempDescription.startDateTime: ", tempDescription.endDateTime);
      ...
      eventTix.tickets.forEach((tix, index) => {
        ...
        let newItem = {
          key: tix.sort ? tix.sort : "", // fetch
          sort: tix.sort ? tix.sort : "", // fetch
          ...
          orderMin: tix.minTicketsAllowedPerOrder ? tix.minTicketsAllowedPerOrder : "", // fetch
          orderMax: tix.maxTicketsAllowedPerOrder ? tix.maxTicketsAllowedPerOrder : "", // fetch
    ...
    <div className={classes.MainContainer}>
      <div className={classes.MainGrid}>
        <div className={classes.GridTitle}>
          {!eventDescription.eventNum ?
            ...
            (<div style={{ paddingTop: "10px"}}>
              <div>Event Edit: <span style={{ fontSize: "26px", fontWeight: "500"}}>{eventDescription.eventNum} - {" "}
        ...
        <div style={{ border: "1px solid grey" }}>
          ...
          <div className={classes.SectionTitleTight}>Event Specific Social Media Links</div>
...
export default EventCreationEdit;
