...
const priceFeatureSettings = (props) => {
  if (props.ticket.priceFeature === "none") {
      ...
      <Fragment>
        ...
        >
          ...
          <button
            ...
            onClick={(event) =>
              props.switchPriceFeature(event, props.ticket.key)
            }
          >
    ...
    if (
      (props.ticket.functionArgs.buy === "" &&
        props.ticket.functionArgs.get === "") ||
      (props.ticket.functionArgs.buy !== "" &&
        props.ticket.functionArgs.get !== "")
    ) {
      props.ticket.functionArgs.reqWarning = false;
      console.log(
        "props.ticket.functionArgs.reqWarning: ",
        props.ticket.functionArgs.reqWarning
      );
    } else {
    ...
    if (!props.ticket.functionArgs.buy) {
      ...
      console.log(
        "ticket.functionArgs.buyWarning: ",
        props.ticket.functionArgs.buyWarning
      );
    } else {
      props.ticket.functionArgs.buyWarning = !bogofRegex.test(
        props.ticket.functionArgs.buy
      );
      console.log(
        "props.ticket.functionArgs.buyWarning: ",
    ...
    if (!props.ticket.functionArgs.get) {
      ...
      console.log(
        "props.ticket.functionArgs.getWarning: ",
        props.ticket.functionArgs.getWarning
      );
    } else {
      props.ticket.functionArgs.getWarning = !bogofRegex.test(
        props.ticket.functionArgs.get
      );
      console.log(
        "ticket.functionArgs.getWarning: ",
        props.ticket.functionArgs.getWarning
      );
    }
      ...
      <Fragment>
        ...
        props.ticket.functionArgs.getWarning ? (
          <div className={classes.BogofLineWarning}>
            ...
            <div style={{ paddingRight: "5px", textAlign: "left" }}>
              {" "}
              {getWarningText}
            </div>
          </div>
    ...
    if (
      (props.ticket.functionArgs.buy === "" &&
        props.ticket.functionArgs.get === "" &&
        props.ticket.functionArgs.discount === "") ||
      (props.ticket.functionArgs.buy !== "" &&
        props.ticket.functionArgs.get !== "" &&
        props.ticket.functionArgs.discount !== "")
    ) {
    ...
    if (!props.ticket.functionArgs.buy) {
      ...
      props.ticket.functionArgs.buyWarning = !bogodRegexNum.test(
        props.ticket.functionArgs.buy
      );
      console.log(
        "props.ticket.functionArgs.buyWarning: ",
    ...
    if (!props.ticket.functionArgs.get) {
      ...
      props.ticket.functionArgs.getWarning = !bogodRegexNum.test(
        props.ticket.functionArgs.get
      );
      console.log(
        "props.ticket.functionArgs.getWarning: ",
    ...
    if (!props.ticket.functionArgs.discount) {
      ...
      console.log(
        "props.ticket.functionArgs.discountWarning: ",
        props.ticket.functionArgs.discountWarning
      );
    } else {
      props.ticket.functionArgs.discountWarning = !bogodRegexPercent.test(
        props.ticket.functionArgs.discount
      );
      console.log(
        "props.ticket.functionArgs.discountWarning: ",
    ...
    if (!props.ticket.functionArgs.buy) {
      ...
      props.ticket.functionArgs.buyWarning = !twoferRegexNum.test(
        props.ticket.functionArgs.buy
      );
      console.log(
        "props.ticket.functionArgs.buyWarning: ",
    ...
    if (!props.ticket.functionArgs.for) {
      ...
      console.log(
        "props.ticket.functionArgs.forWarning: ",
        props.ticket.functionArgs.forWarning
      );
    } else {
      props.ticket.functionArgs.forWarning = !twoferRegexPrice.test(
        props.ticket.functionArgs.for
      );
      console.log(
        "props.ticket.functionArgs.forWarning: ",
    ...
    if (
      ...
      if (
        props.ticket.functionArgs.for >
        props.ticket.functionArgs.buy * props.ticket.currentTicketPrice
      ) {
    ...
    return (
      <Fragment>
        ...
        props.ticket.functionArgs.buyWarning ||
        props.ticket.functionArgs.forWarning ||
        props.ticket.functionArgs.maxForWarning ? (
