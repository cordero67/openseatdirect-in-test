...
const EventCreation = () => {
    ...
    const additionalSettings = (ticket, value) => {
                ...
                {ticketDetails.map( (item, index) => {
                    ...
                    return (
                        <div key={index}>
                            ...
                            {item.settings ? additionalSettings(item, "parent") : null}
                        </div>
                    )
                })}
            </div>
                ...
                {ticketDetails.map( (item, index) => {
                    return (
                        <TicketType
                            ticket={item}
                            key={item.key}
                            //additional={launchAdditional}
                            change={event => changeTicketDetail(event, item.key)}
                            switch={event => switchTicketSettings(event, item.key)}
                            delete={event => deleteTicket(event, item.key)}
                            additional={(ticket) => {additionalSettings(ticket, "child");
                                console.log("addtional occurred")}}
                        />
                    )
                })}
