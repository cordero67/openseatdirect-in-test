    ...
    <div>
      {props.ticket.promoCodes.map((item, index) => {
        ...
        if (item.percent === false) {
          finalPrice = (props.ticket.currentTicketPrice - item.amount).toFixed(
            2
          );
