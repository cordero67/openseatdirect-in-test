...
const Events = (props) => {
  ...
  const handleErrors = (response) => {
    ...
    console.log ("in handleErrors> response.status>", response.status)
    if (!response.ok) {
  ...
  const loadServerData = () => {
    ...
    let accountNum = tempUser.user.accountNum;
...
//    let fetchstr = `${API}/event/alluser/${vendorId}`;
    let fetchstr = `${API}/organizers/${accountNum}/events`;
    ...
    fetch(fetchstr, requestOptions)
      ...
      .then((result) => {
        ...
        fetchstr = `${API}/organizers/${accountNum}/orders`;
        ...
        fetch(fetchstr, requestOptions)
          ...
          .catch((error) => {       // inside catch
            console.log("inside order error", error);
