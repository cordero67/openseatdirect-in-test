...
const TicketSelection = () => {
  ...
  const checkoutButton = () => {
    ...
    if (
      ...
      //eventDetails.eventNum === 96587655611 &&
      ...
      return (
        ...
        >
          YES {eventDetails.register.buttonLabel.toUpperCase()}
        </button>
      );
    } else if (
      eventDetails.register &&
      ...
      return (
        <button disabled={true} className={classes.ButtonGreenOpac}>
          NO {eventDetails.register.buttonLabel.toUpperCase()}
        </button>
      );
    } else if (
  ...
  const registration = () => {
    if (display === "registration") {
      console.log("registrationIndex: ", registrationIndex);
      console.log("length: ", eventDetails.register.content.length);
      return (
        <div
          className={classes.BlankCanvas}
          style={{
              ...
              onClick={() => {
                if (
                  ...
                  if (
                    ...
                    console.log("this is a signed free order");
                    freeTicketHandler();
                  } else if (
                    (orderTotals.finalPurchaseAmount > 0 &&
                      customerInformation.sessionToken !== "") ||
                    ...
                    console.log(
                      "this is a signed paid order or an unsigned order"
                    );
                    storeOrder();
                  } else {
                    console.log("this is some other type of order");
                  }
                }
              }}
            >
              {eventDetails.register.contentButton}
            </button>
          </div>
