...
export const OrderConfirm = props => {
    ...
    if (props.orderStatus) {
      ...
      return (
        <div style={{paddingBottom: "20px"}}>
          <div style={{paddingBottom: "20px"}}>
            ...
            <span style={{color: "blue", fontWeight: "600", paddingBottom: "20px"}}>
      ...
      return (
        <div style={{paddingBottom: "20px"}}>
          ...
          <div style={{paddingBottom: "20px"}}>
            Within 48 hours, OpenSeatDirect will be sending you a message to your email:{" "}
  ...
  if (dateFormat(props.transactionInfo.startDateTime, "m d yy", true) === dateFormat(props.transactionInfo.endDateTime, "m d yy", true)) {
    dateRange =
      <Fragment>
        {dateFormat(props.transactionInfo.startDateTime, "ddd, mmm d, yyyy - h:MM TT", true)}{" "}
    ...
    dateRange =
      <Fragment>
        {dateFormat(props.transactionInfo.startDateTime, "ddd, mmm d, yyyy - h:MM TT", true)}{" "}
        to {dateFormat(props.transactionInfo.endDateTime, "ddd, mmm d, yyyy - h:MM TT", true)}
    </Fragment>
  }
  ...
  const webinarLink = (
    <div>
      ...
      <div style={{paddingBottom: "20px"}}>{props.transactionInfo.webinarLink}</div>
    </div>
  )
  ...
  const eventDetails = () => {
    return (
      <Fragment>
        ...
        <div>
          {props.transactionInfo.webinarLink ? webinarLink : null}
        </div>
      </Fragment>
    )
  }
  ...
  return (
    <Fragment>
      ...
      <div className={classes.Body}>
        ...
        {eventDetails()}
        <div style={{textDecoration: "underline", fontWeight: "600", paddingBotton: "10px"}}>
          Order Details
        </div>
        <div style={{paddingBottom: "20px"}}>
