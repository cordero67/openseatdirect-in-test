    ...
    return (
      <div className={classes.MainContainer}>
        <div className={classes.MainGrid}>
          <section className={classes.Events}>{arg}</section>
        </div>
      </div>
    );
  };
  ...
  if (isLoading) {
    ...
    return showWrapper(
      <div style={{ fontSize: "20px" }}>
        There was a network connectivity problem. Please check your connection,
    ...
    return showWrapper(
      <div style={{ fontSize: "20px", color: "red" }}>
        System problem. Please click the back button on your browser and try
        again...
      </div>
    );
  } else if (!data) {
