    ...
    bottomDisplay = (
      <div className={styles.LowerGrid}>
        ...
        <div className={styles.RightLowerGrid}>
          ...
          <div className={styles.TextRight}>Various</div>
          <div className={styles.TextRight}>Philadelphia, PA</div>
        </div>
      </div>
    );
  } else {
    bottomDisplay = (
      <div className={styles.LowerGrid}>
        <div className={styles.LeftLowerGrid}>
          ...
          <div className={styles.TextLeft}>Various</div>
          <div className={styles.TextLeft}>Philadelphia, PA</div>
          <br></br>
          <div className={styles.TitleLeft}>Event Details</div>
          <div className={styles.TextLeft}>
            <div>
